...
В связи с особенностями реализации и лицензирования, программный продукт предоставляется в составе **оффлайн-комплекта на физическом носителе (USB)**, включающего:
...
8. **Проверка концептуальных основ**  
   ...
   - *MESmachine — MES по стандартам (ISA-95, IEC 62264), том 3*
...
Программное обеспечение **MESmachine** является проприетарным продуктом.  
Права на него принадлежат правообладателю — **Бреславскому Михаилу Петровичу**.
...
Указанная информация включена в оффлайн-документацию и может быть предоставлена по запросу.

---

## 📑 Подтверждение принадлежности страницы

Настоящим подтверждаю, что данный GitHub-репозиторий  
[https://github.com/inuente/MESmachine](https://github.com/inuente/MESmachine)  
создан и администрируется правообладателем программного обеспечения **MESmachine** —  
**Бреславским Михаилом Петровичем**.

Репозиторий используется для публикации сведений, связанных с подачей заявки в Реестр российского ПО.

---

## 📎 Контакт для получения акта или дополнительной информации:
